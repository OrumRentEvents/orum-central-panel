...
function construirDiarioComercial(d, nombre) {
  ...
  const cuerpo = `<div style="margin-top:20px;">${kpiFila(
...
function construirSemanalDireccion(d) {
  ...
  const cuerpo = objetivoHtml + evolucionHtml + H2('Resumen por comercial') + tabla + H2('Análisis por comercial') + analisis +
