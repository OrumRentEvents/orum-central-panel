...
async function obtenerEstadisticasMaterial() {
  const [normalData, pncData, costesData] = await Promise.all([
    ...
    selectAll('costes_adicionales', 'articulo,cantidad,importe')
  ]);
...
module.exports = { llamarOrumCentralSupabase, obtenerMaterialDeProyecto, obtenerDetalleProyecto, obtenerConductores, obtenerEstadoVehiculos, obtenerEstadisticasRutas, obtenerEstadisticasMaterial, ACCIONES, supabase };
